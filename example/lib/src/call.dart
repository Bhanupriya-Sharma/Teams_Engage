...
class _CallPageState extends State<CallPage> {
  ...
  Future<void> initialize() async {
    if (APP_ID.isEmpty) {
      setState(() {
        _infoStrings.add(
          'APP_ID missing, please contact the Owner of the App',
        );
        _infoStrings.add('Video Call is not starting');
      });
      return;
    }
        ...
        children: <Widget>[
          RawMaterialButton(
            ...
            child: Icon(
              ...
              color: Colors.black, //purple & white
              size: 20.0,
            ),
            shape: CircleBorder(),
            elevation: 2.0,
            fillColor: muted ? Colors.deepPurple : Colors.white,
            //purple & white
